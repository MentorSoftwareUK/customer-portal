...
<template>
  ...
  <div class="bg-white border-b border-gray-200 -mx-6 px-6 lg:-mx-12 lg:px-12 mb-6 -mt-6">
    ...
    <!-- Magenta underline — always present per v3 spec -->
    <div class="h-0.5 bg-gradient-to-r from-[#e7007e] to-transparent" />
  </div>
</template>
