...
const { isLight, toggle: toggleTheme } = useAdminTheme()
...
<template>
  <div class="antialiased bg-[#e2e2e2] text-gray-900">
      ...
      <div class="flex flex-wrap items-center justify-between">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <button
            ...
            @click="toggleTheme"
          >
            <svg v-if="!isLight" aria-hidden="true" class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clip-rule="evenodd"></path>
            </svg>
            <svg v-else aria-hidden="true" class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <ul class="space-y-2">
          ...
          <li>
            <RouterLink
              ...
              class="group flex items-center rounded-lg p-2 text-base font-medium"
              :class="isActive('/admin/ticket-stats') ? 'bg-white/10 text-white' : 'text-white/80 hover:bg-white/10 hover:text-white'"
            >
              <svg
                aria-hidden="true"
                class="h-6 w-6 flex-shrink-0 text-white/50 transition duration-75 group-hover:text-white"
              ...
              <span class="ml-3">Ticket stats</span>
            </RouterLink>
          </li>
    ...
    <main id="main-content" :class="['min-h-screen bg-[#e2e2e2] pt-20 md:ml-64 text-gray-900', { 'admin-light': isLight }]">
