    ...
    <div class="hidden lg:flex lg:w-1/2 bg-white p-10">
      <div class="w-full rounded-2xl p-10 flex flex-col justify-between" style="background-color: #14192D;">
        ...
        <div class="text-white">
          <h2 class="text-5xl font-bold leading-tight mb-4">Mentor Software<br>Customer Portal</h2>
          <p class="text-sm opacity-60">Knowledge base &amp; guides &nbsp;|&nbsp; Support tickets &nbsp;|&nbsp; Events &amp; training &nbsp;|&nbsp; Book meetings</p>
        </div>
        <div />
      </div>
    </div>
