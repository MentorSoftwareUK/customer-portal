          ...
          <div class="mt-3 overflow-x-auto">
            <table class="w-full text-left text-xs">
              ...
              <tbody>
                ...
                >
                  <td class="max-w-[180px] truncate py-2.5 pr-4">
                    <a :href="c.hubspotUrl" target="_blank" rel="noopener" class="text-white/80 hover:text-amber-300 transition-colors">
                      {{ c.name }}
                      <svg class="ml-1 inline h-3 w-3 text-white/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                    </a>
                  </td>
